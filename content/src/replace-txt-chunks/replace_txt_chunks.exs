#!/usr/bin/env elixir
# content/src/replace-txt-chunks/replace_txt_chunks.exs
# =============================================================================
# Usage:
#   $ SRCS=https://rgolubtsov.github.io/srcs; \
#     curl -sOk ${SRCS}/replace-txt-chunks/replace_txt_chunks.exs   && \
#     chmod 700 replace_txt_chunks.exs;  ./replace_txt_chunks.exs;  echo $?
# =============================================================================
...
# =============================================================================
# Copyright (C) 2018-2026 Radislav (Radicchio) Golubtsov
#
