#!/usr/bin/env groovy
/* content/src/replace_txt_chunks.groovy
 * ============================================================================
 * Usage:
 * $ curl -sO http://rgolubtsov.github.io/srcs/replace_txt_chunks.groovy && \
     chmod 700                                 replace_txt_chunks.groovy && \
                                           ./replace_txt_chunks.groovy; echo $?
 * ============================================================================
