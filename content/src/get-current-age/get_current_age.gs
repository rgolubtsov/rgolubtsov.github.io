...
/* content/src/get-current-age/get_current_age.gs
 * ============================================================================
 * Usage:
 *   $ SRCS=https://rgolubtsov.github.io/srcs; \
       curl -sOk ${SRCS}/get-current-age/get_current_age.gs   && \
       chmod 700 get_current_age.gs;   ./get_current_age.gs;  echo $?
 * ============================================================================
...
def get_age(YY_OF_BIRTH:int, MM_OF_BIRTH:int, DD_OF_BIRTH:int):int
...
init
	print(get_age(1977, 6, 27).to_string()) // <== 1977-06-27.
