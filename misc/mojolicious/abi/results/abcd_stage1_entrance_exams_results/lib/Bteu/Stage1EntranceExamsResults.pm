#
# lib/Bteu/Stage1EntranceExamsResults.pm
# =============================================================================
...
package Bteu::Stage1EntranceExamsResults;
...
sub startup($self) {
    ...
    $router->get ("/results"          )->to("Results#go_results" );
    $router->get ("/results/rezultaty")->to("Results#get_results");
