...
sub get_user_from_db($username, $password, $dbh) {
    my $get_user_sql_select = "select"
            ...
            . " (select"
                    . " subject_name"
                . " from"
                    . " bteu_stage1_entrance_exams_results_subjects"
                . " where"
                    . " subject1_id = id)             as subject1,"
            . " to_char((select"
                    . " exam_date"
                . " from"
                    . " bteu_stage1_entrance_exams_results_exams_dates"
                . " where"
        ...
        . " from"
            . " bteu_stage1_entrance_exams_results_users,"
            . " bteu_stage1_entrance_exams_results_studying_forms sf,"
            . " bteu_stage1_entrance_exams_results_subjects       subj,"
            . " bteu_stage1_entrance_exams_results_exams_dates    date"
        . " where"
            . " (username         =       ?) and"
            . " (password         =       ?) and"
